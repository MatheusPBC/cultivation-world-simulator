...
export type SelectionType = 'avatar' | 'region' | 'sect' | 'poi' | 'site' | 'route';
...
export const useUiStore = defineStore('ui', () => {
  ...
  const detailData = shallowRef<AvatarDetail | RegionDetail | SectDetail | POIDetail | InfrastructureSiteDetail | RouteDetail | null>(null);
