  ...
  it('renders localized tradition and initiator labels', () => {
          ...
          game: {
            ...
            world_journal: {
              ...
              dao: {
                ...
                status: { signed: '降下征兆' }, initiator: { avatar: '人物' },
              },
            },
          },
        },
    ...
    const wrapper = mount(DaoPetitionsView, {
      props: {
        ...
        respondingId: null,
        petitions: {
          pending: [{ id: 'p1', initiator_kind: 'avatar', initiator_id: 'a1', initiator_name: 'Lin', region_id: 7, tradition: 'mercy', motivated_event_ids: ['e1'], content: 'Please witness.', created_month: 1, status: 'pending', response_event_id: null, response_content: '', favor_expires_month: null }],
          history: [],
        },
      },
      global: { plugins: [i18n] },
    ...
    expect(wrapper.text()).not.toContain('mercy · avatar')
  })
  ...
  it('keeps resolved petitions secondary and opens their response evidence', async () => {
    const i18n = createI18n({
      ...
      messages: { 'zh-CN': { game: { info_panel: { region: { dao_traditions: { mercy: '慈悲' } } }, world_journal: { why_button: '为什么？', dao: {
        eyebrow: '天道意志', title: '天道请愿', description: '说明', loading: '加载', retry: '重试', empty: '空', silence: '沉默', sign: '征兆', favor: '赐福', history: '已回应的请愿', response: '天道回应', response_why: '查看回应缘由', favor_until: '机会持续至第 {month} 月', status: { favored: '赐予机会' }, initiator: { avatar: '人物' },
      } } } } },
    })
    const wrapper = mount(DaoPetitionsView, {
      props: { loading: false, error: false, respondingId: null, petitions: {
        pending: [],
        history: [{ id: 'p1', initiator_kind: 'avatar', initiator_id: 'a1', initiator_name: 'Lin', region_id: 7, tradition: 'mercy', motivated_event_ids: ['cause'], content: 'Please witness.', created_month: 1, status: 'favored', response_event_id: 'answer-event', response_content: 'A sign crosses the sky.', favor_expires_month: 13 }],
      } },
      global: { plugins: [i18n] },
    })
